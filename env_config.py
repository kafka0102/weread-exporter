...
# 书间 / 章间节奏（批量与导出）
# 批量导出相邻两本书之间的固定间隔
SLEEP_BOOK_INTERVAL = env_float("SLEEP_BOOK_INTERVAL", 180.0)
# 章完成后按字数动态等待：ceil(chars/1000)*PER_1K，再夹到 [MIN, MAX]
SLEEP_CHAPTER_PER_1K_CHARS = env_float("SLEEP_CHAPTER_PER_1K_CHARS", 2.0)
SLEEP_CHAPTER_MIN = env_float("SLEEP_CHAPTER_MIN", 2.0)
SLEEP_CHAPTER_MAX = env_float("SLEEP_CHAPTER_MAX", 15.0)
